    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                db.addOrder(username,editTextFullName.getText().toString(),editTextAddress.getText().toString(),editTextContactNo.getText().toString(),Integer.parseInt(editTextPinCode.getText().toString()),date.toString(),"",Float.parseFloat(price[1].toString()),"Medicine");
